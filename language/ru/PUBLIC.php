...
//{IDs_0003} Кнопки
$LNG['buttonPlayNow']				                 = 'Играть сейчас';
...
$LNG['registerPasswordRequired']			         = 'требуется пароль';
...
$LNG['news_buttonBack']					             = 'Назад';
$LNG['news_buttonContinue']					         = 'Продолжать';
...
//{IDs_0011} Index
$LNG['subTitle']            		                 = 'космическая стратегия';
$LNG['aboutGame']            		                 = 'Что такое New-Star?';
$LNG['aboutGameDesc1']            		             = 'New-Star - это многопользовательская игра в жанрах "менеджмент / стратегия", основанная на веб-браузере и основанная на полностью изобретенной научной фантастической вселенной. Вы начинаете с одного неразвитого мира и превращаете его в могущественную империю, способную защитить ваши кровно заработанные колонии.';
$LNG['aboutGameDesc2']            		             = 'Испытайте освоение космоса, слияние космоса и живую вселенную.';
$LNG['aboutGameDesc3']            		             = 'Участвуйте во многих игровых событиях, таких как исследования, рейды и творения.';
$LNG['gameplayTitle']            		             = 'Геймплей';
$LNG['gameplaySubTitle']            		         = 'Новая звезда предлагает различные функции и игровую механику.';
$LNG['gameplayExploration']            		         = 'Исследование';
$LNG['gameplayExplorationDesc']            		     = 'В новой Империи вам нужно исследовать космос и достигать далеких звезд и галактик. В этом приключении вы найдете различные события, виды, планеты и многое другое. Но учтите, что в космосе не все дружелюбно.';
$LNG['gameplayExpansion']            		         = 'Расширение';
$LNG['gameplayExpansionDesc']            		     = 'По мере роста вашей планеты вы также перейдете на другую планету и создадите свою империю. Колонизируйте далекие планеты или даже луны. Создайте могущественную империю, способную победить скрытые опасности';
$LNG['gameplayEconomics']            		         = 'Экономика';
$LNG['gameplayEconomicsDesc']            		     = 'Для получения прибыли и расширения вы будете искать и добывать 8 ресурсов. У каждого ресурса есть собственный питомник, что дает вам новые возможности для торговли и процветания вашей империи.';
$LNG['gameplayConquest']            		         = 'Завоевание';
$LNG['gameplayConquestDesc']            		     = 'Вы не одиноки в галактиках. В своем приключении вы встретите инопланетян, другие империи, которые могут быть союзниками или врагами. С более чем 32 кораблями вы создадите могучий флот, способный покорить целые галактики.';
$LNG['newsAndComunity']            		             = 'Новости и сообщество';
$LNG['newsAndComunityDesc1']            		     = 'Представьте себе вселенную, которая ждет исследований и эволюции. New Star постоянно развивается в зависимости от действий игроков.';
$LNG['newsAndComunityDesc2']            		     = 'Сообщество Taught игра развивается и предлагает всегда новый контент, внутриигровые события.';
$LNG['callToAction']            		             = 'Чего же ты ждешь? Присоединяйся сейчас';
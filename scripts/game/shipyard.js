...
$(document).ready(function(){
	...
	if($(window).width() >= 1024){
		...
		$('#buildQueue').show()
		$('#buildContent').show()
		$('#buildProgressMobile').hide();
	}

	var allRanges = document.querySelectorAll(".c-rangeSlider");
	allRanges.forEach(wrap => {
	var range = wrap.querySelector(".c-rangeSlider__slider");
	var bubble = wrap.querySelector(".c-rangeSlider__bubble");
